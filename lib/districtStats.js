...
export const DISTRICT_METRICS = [
  { key: "plazas", source: "geocoded", cacheKey: "plazas", label: "広場", color: "#2F6F6E" },
  { key: "featuredParks", source: "geocoded", cacheKey: "featuredParks", label: "特色のある公園", color: "#B8862F" },
  { key: "nursery", source: "geocoded", cacheKey: "publicNurseryFacilities", label: "公立保育所", color: "#8F6A22" },
