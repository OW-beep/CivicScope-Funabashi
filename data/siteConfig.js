...
export const datasets = {
  ...
  // 保育施設数及び定員数の推移：各年4月1日現在の施設数・定員数・入所児童数・待機数を
  // 保育所（公立/民間）・認定こども園・小規模保育事業・事業所内保育事業の5区分＋合計で収録。
  // 列がShift_JIS由来の文字化けを起こしやすいため、lib/bodik.jsのnormalizeChildcareCapacity()
  // では列名パターンではなく列の「位置」で機械的に区切っている（内訳合計＝合計列であることを
  // Pythonで検算済み）。
  childcareCapacity: {
    id: "122041_nyusyosinseinyusyojidou",
    label: "保育施設数及び定員数の推移",
    description: "保育施設の施設数・定員数・入所児童数・待機数の推移（各年4月1日現在）。",
    sourceUrl: "https://data.bodik.jp/dataset/122041_nyusyosinseinyusyojidou"
  },
  temporaryCare: {
    id: "122041_itijiazukaririyojokyo",
    label: "一時預かり利用状況",
    description: "一時預かり事業の利用実績（単位：人）。",
    sourceUrl: "https://data.bodik.jp/dataset/122041_itijiazukaririyojokyo"
  },
  sickChildcare: {
    id: "122041_byojibyogojihoikuriyou",
    label: "病児保育利用者数",
    description: "病児保育の利用実績（単位：人）。",
    sourceUrl: "https://data.bodik.jp/dataset/122041_byojibyogojihoikuriyou"
  },
  publicNurseryFacilities: {
    id: "122041_kourituhoikuseibijoukyou",
    label: "公立保育所整備状況の推移",
    description:
      "市内27の公立保育所それぞれの定員・建物構造・敷地面積・延床面積・増改築履歴の一覧（データ名は「推移」ですが、実際の中身は年次系列ではなく施設ごとの整備状況一覧です）。",
    sourceUrl: "https://data.bodik.jp/dataset/122041_kourituhoikuseibijoukyou"
  },
  plazas: {
    id: "122041_hiroba",
    label: "広場 詳細情報",
    description:
      "\u201cいきいきふれあいマップ\u201dで公開されている、市内の小規模な広場（遊び場）の一覧。施設名称・開設年月日・面積・遊具の有無などを収録。",
    sourceUrl: "https://data.bodik.jp/dataset/122041_hiroba"
  },
  featuredParks: {
    id: "122041_tokusyoku",
    label: "特色のある公園 詳細情報",
    description: "\u201cいきいきふれあいマップ\u201dで公開されている、特色のある公園（遊具・運動施設が充実した公園等）の一覧。",
    sourceUrl: "https://data.bodik.jp/dataset/122041_tokusyoku"
  },
  schoolStudents: {
