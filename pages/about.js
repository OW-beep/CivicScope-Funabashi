...
export default function About() {
  return (
    <>
      <Seo title={`About｜${siteConfig.name}`} description="CivicScope船橋の運営方針、データの出典、免責事項について。" path="/about" />
      ...
      <section className="mx-auto max-w-2xl px-5 py-14">
        ...
        <div className="mt-10 space-y-10 text-[15px] leading-[1.9] text-ink-soft">
          ...
          <div>
            ...
            <p className="mt-4">
              運営者自身、他所から船橋市に引っ越してきて、現在も暮らしています。移り住む際に重視したのは
              駅・交通の便で、実際に暮らしてみても、そこに不満を感じたことはありません。市内では特に北部
              （鎌ヶ谷・西船橋方面）エリアに思い入れがあり、中心市街地とはまた違った暮らしやすさを、この
              サイトの記事でも折に触れて紹介しています。データへの関心は特定の分野に絞らず、人口・子育てから
              防災、ごみ・リサイクルまで幅広く、船橋市に関するデータであれば基本的に何でも掘り下げたいと
              思っています。
            </p>
          </div>
          ...
          {/* カテゴリカラーの由来は、目立たせる情報ではないため、ページ末尾に小さく補足として記載 */}
          <p className="border-t border-ink/10 pt-6 text-xs leading-relaxed text-ink-soft/70">
            ダッシュボード一覧などで使われている分野別のカラーは、船橋市にゆかりのある配色（南部・三番瀬の海の青、
            人々の心を表す赤紫、商工業の成熟を表すえんじ色、北部の里山の緑、市の花木にちなむひまわり色・サザンカ色）を
            参考にしています。
          </p>
        </div>
      </section>
