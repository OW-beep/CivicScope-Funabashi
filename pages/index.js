  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-5xl px-5 pb-6">
        <Link
          href="/area-map"
          className="group flex flex-col items-start gap-4 border border-ink/10 bg-white/50 p-6 transition-colors hover:border-brass sm:flex-row sm:items-center sm:justify-between"
        >
          <div>
            <span className="font-mono text-xs uppercase tracking-widest text-brass-dark">Illustrated Map</span>
            <h2 className="mt-1 font-display text-xl text-ink group-hover:text-brass-dark">
              船橋市 エリアマップを見る
            </h2>
          ...
          <span className="shrink-0 font-mono text-xs text-ink-soft group-hover:text-brass-dark">
            地図を見る →
          </span>
        </Link>
      </section>
